...
## Module Information
```{r}
course <- "COR1305" #edit intended course
course_name <- "Spreadsheet Modelling and Analytics" #edit intended course name
semester <- "Y2S1"
max_range <- 60
instructor <- "WANG HAI"
```
...
```{r Bidding Price vs ALL Instructor, echo=FALSE}
...
#View(bidding_data_with_averages)
...
```{r Bidding Price vs SPECIFIC Instructor, echo=FALSE}
